      ...
      <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden lg:flex">
        ...
        <div className="relative z-10 flex flex-col h-full justify-between p-12">
          ...
          <div>
            ...
            >
              <h2 className="mb-3 text-4xl font-bold text-white leading-tight">
                Join 50,000+
                <br />
                <span className="text-gradient-hero">smart travelers</span>
              </h2>
              <p className="mb-10 text-white/60 text-lg">
                Start planning your dream India trip with AI intelligence.
              </p>
          ...
          <p className="text-xs text-white/30">© 2026 Yatri AI · Intelligent Indian Trip Planner</p>
        </div>
      </div>
      ...
      <div className="flex w-full min-h-screen items-center justify-center bg-background px-6 py-12 lg:w-1/2 lg:min-h-0">
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="mt-2 text-sm text-muted-foreground">Start planning your dream trips for free</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="group relative">
              <User size={16} className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground transition-colors group-focus-within:text-primary" />
              <input
                type="text"
                value={name}
            ...
            {password.length > 0 && (
              ...
              >
                ...
                <p className="text-xs text-muted-foreground">
                  Password strength:{" "}
                  <span className={`font-medium ${passwordStrength >= 3 ? "text-emerald-400" : passwordStrength >= 2 ? "text-yellow-400" : "text-red-400"}`}>
                    {password.length > 0 ? strengthLabels[passwordStrength - 1] || "Too weak" : ""}
                  </span>
                </p>
              </motion.div>
            )}
